<template>
  <el-card>
    ...
    <el-row :gutter="20" class="header">
      <!-- 添加 -->
      <el-button type="primary" @click="handleDialogValue()">添加日程</el-button>
      <!-- 多选 -->
      <el-button
        v-model="Visible"
        v-if="Visible"
    ...
    <el-pagination
      ...
      @initUserList="initGetScheduleList"
    />
  </el-card>
...
// 得到用户数据
const initGetScheduleList = async () => {
  const res = await getSchedule(queryForm.value)
  // console.log(res)
